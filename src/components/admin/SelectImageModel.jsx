...
export default function ImageSelectDialog({ isSingle = false, isOpen, onClose, onSubmit, alreadySelected }) {
    ...
    // console.log('adfaf==>',alreadySelected);
    ...
    const handleSubmit = () => {
        if (isSingle) {
            onSubmit(selectedImages); // Returns single URL or null
        } else {
            onSubmit(selectedImages || []); // Always returns array
        }
        onClose();
    };
    ...
    return (
        ...
        >
            <div
                className={`overflow-hidden rounded-lg border border-gray-200 bg-white shadow dark:border-gray-700 dark:bg-gray-800 ${isDragging ? 'ring-2 ring-purple-500' : ''}`}
                ...
                <div className="p-4 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between">
                    ...
                    <div className="flex items-center justify-center gap-4">
                        ...
                        {!isSingle && selectedImages?.length > 0 && (
                            <span className="ml-4 px-3 py-1 rounded-full bg-purple-100 text-purple-800 text-sm font-medium dark:bg-purple-900/30 dark:text-purple-200">
                        ...
                        onClick={()=> setIsDialog({show:true,data:{},type:'add'})}
                            type="button"
                            className="inline-flex cursor-pointer items-center rounded-md border border-transparent bg-purple-600 px-4 py-2 text-sm font-medium text-white shadow-sm hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 gap-2"
                        >
                            <Plus />
                            Add Image
                        </button>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 p-4">
                            {currentItems?.map((image) => (
                                <div
                                    ...
                                    className={`relative group rounded-lg border overflow-hidden shadow-sm hover:shadow-md transition-all cursor-pointer ${isSelected(image.url)
                                    ...
                                    <div className="p-3">
                                        ...
                                        <div className="mt-3 flex justify-end space-x-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                            <button
                                                ...
                                                className="rounded-full cursor-pointer p-1.5 text-purple-600 hover:bg-purple-50 dark:text-purple-400 dark:hover:bg-gray-600"
                                                title="Edit"
                                            >
                        ...
                        <div className="flex items-center space-x-4">
                            <div className="flex items-center space-x-2">
                                ...
                                <select
                                    ...
                                    className="rounded-md border border-gray-300 bg-white px-2 py-1 text-sm focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                                >
                                    {[12, 24, 48, 96].map((n) => (
                            ...
                            <div className="flex items-center space-x-2">
                                <button
                                    ...
                                    className="inline-flex items-center rounded-md border border-gray-300 bg-white px-3 py-1.5 text-sm font-medium text-gray-700 shadow-sm hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:ring-offset-2 disabled:opacity-50 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:hover:bg-gray-600"
                                >
                                    Previous
                                </button>
